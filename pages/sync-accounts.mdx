...
```js
fetch("https://sync.morgen.so/v1/integrations/:providerId/oauth/authorizationUrl?redirect_url=<REDIRECT_URL>", {
    method: "GET",
    headers: {
...
```js
fetch("https://sync.morgen.so/v1/integrations/accounts/:accountId/disconnect", {
    method: "POST",
    headers: {
        "accept": "application/json",
        "Authorization": "Bearer <JWT>"
...
```js
fetch("https://sync.morgen.so/v1/integrations/accounts/list", {
    method: "GET",
    headers: {
        "accept": "application/json",
        "Authorization": "Bearer <JWT>"
...
```js
fetch("https://sync.morgen.so/v1/integrations/list", {
    method: "GET",
    headers: {
        "accept": "application/json"
    }
