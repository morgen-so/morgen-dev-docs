...
The JWT Token must be signed with the Client Secret of the application that is making the request.
...
<Callout type="warning" emoji="⚠️">
  Your Client Secret grants access to all resources associated with the Client ID. 
  It is paramount that you keep your Client Secret confidential and do not share it with anyone.
  In particular, do not include the Client Secret in your client-side code.
</Callout>
