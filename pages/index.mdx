...
### Custom Workflow: Set newly event description written by ChatGPT
The following code snippet shows how to use the `fetchMorgen` and `getOpenAIResponse` to _"Write a movie trailer script for a movie of this title"_ as description of all your events based on its title.
